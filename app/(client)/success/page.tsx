...
const SuccessPage = () => {
  ...
  // ✅ استخدام dispatch من Redux Toolkit
  ...
  useEffect(() => {
    if (orderNumber) {
      dispatch(resetCart()); // ✅ استدعاء من Redux بدل useCartStore
    }
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center bg-gray-50 p-2 rounded">
              ...
              <span className="text-sm font-medium px-2 py-1 bg-gray-200 rounded-full"></span>
            </div>
          </div>
        </div>
